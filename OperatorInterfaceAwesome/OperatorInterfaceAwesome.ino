/*
 * Operator Interface Robo-Obstacle Course
 * ---------------------------------------
 * 
 * Custom interface for the Robo-Obstacle Course
 * workshop at the Canadian Science and Technology
 * Museum, in collaboration with MadeMill
 * 
...
void setup() {
  ...
  setButtonLabel("Up", 3, 1);
  setButtonLabel("Mid", 4, 1);
  setButtonLabel("Down", 5, 1);

  setButtonLabel("Dance", 0, 3);
  setButtonLabel("Blink", 1, 3);
  setButtonLabel("Wave", 2, 3);
  setButtonLabel("Sleep", 3, 3);
  setButtonLabel("AWSUM", 4, 3);

  setModeLabel("Control", 1);
  setModeLabel("N/A", 2);
  setModeLabel("EXTRA", 3);
